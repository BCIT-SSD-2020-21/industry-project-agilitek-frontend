                ...
                <div className="px-4 py-5 bg-white sm:p-6">
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-3 mt-5">
                      ...
                      >
                        ...
                        {dbTables.map((dbTable, idx) => {
                          return (
                            <option value={dbTable.table_name} key={idx}>
                              {dbTable.table_name}
                            </option>
                          );
                        })}
                    ...
                    <div className="col-span-6 sm:col-span-3 mt-5">
                      ...
                      >
                        ...
                        {workflows.map((workflow, idx) => {
                          return (
                            <option value={workflow.url} key={idx}>
                              {workflow.label}
                            </option>
                          );
                        })}
                  ...
                  <div className="col-span-6 sm:col-span-3 mt-5">
                    <Switch.Group as="div" className="flex items-center">
                      <Switch
                        checked={active}
                        onChange={handleAutomationSwitch}
                ...
                <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                  ...
                  {id && (
                    <button
                      ...
                      style={{
                        backgroundColor: processsing && 'grey',
                      }}
